...
module.exports = {
  async apply(value, previousValues) {
    return new Promise(resolve => {
      console.log('\n');
      console.log(
        'TheCodingMachine React-Native AppTwo initialized with success ! 🚀\n',
      );
      console.log(
        `${green(
          '                                                                    .-`    `::  \n' +
      ...
      console.log(
        '- 📚 If you need to read more about this apptwo : https://thecodingmachine.github.io/react-native-apptwo/',
      );
      console.log(
        '- 🤕 If you have some troubles : https://github.com/thecodingmachine/react-native-apptwo/issues',
      );
      console.log(
        '- ⭐ If you love this apptwo, give us a star, you will be a ray of sunshine in our lives :) https://github.com/thecodingmachine/react-native-apptwo',
      );
